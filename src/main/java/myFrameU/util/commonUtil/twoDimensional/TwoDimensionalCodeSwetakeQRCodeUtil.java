...
public class TwoDimensionalCodeSwetakeQRCodeUtil {
	private static int DEFAULT_WIDTH;  
    private static int UNIT_WIDTH = 10;  
  
    public static void main(String args[]) throws Exception{  
    	String FilePath="E:/QRCode.png"; 
        //createImg(FilePath,"www.esnsc.com");  
        createImg(FilePath,"http://www.esnsc.com/");  
    }  
  
    public static void createImg(String FilePath,String content){  
