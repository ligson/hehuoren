package myFrameU.util.commonUtil.json;
...
public class JSONUtils
{
    ...
    public static <T> T toBeanOld(String jsonStr, Class<T> beanClass)
    {
    	JSONArray array = JSONArray.fromObject(jsonStr);
    	Object[] obj = new Object[array.size()];        
        for(int i = 0; i < array.size(); i++){        
    ...
    public static <T> List<T> toBeanList(String jsonStr, Class<T> beanClass)
    {
        ...
        for(int i = 0; i < array.size(); i++){        
            JSONObject jsonObject = array.getJSONObject(i);   
            list.add((T)JSONObject.toBean(jsonObject, beanClass));
        }        
        return list; 
    }
     ...
     * @return
     */
    public static <T> List<T> toBeanList_collection(String jsonStr, Class<T> beanClass,HashMap<String,Class> map)
    {
    	//jsonStr="["+jsonStr+"]";
    	JSONArray array = JSONArray.fromObject(jsonStr);
    	List<T> list = new ArrayList<T>();
        for(int i = 0; i < array.size(); i++){        
            JSONObject jsonObject = array.getJSONObject(i);   
            list.add((T)JSONObject.toBean(jsonObject, beanClass,map));
        }        
        return list; 
    }
