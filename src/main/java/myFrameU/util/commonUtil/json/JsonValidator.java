...
public class JsonValidator {
    ...
    public static void validate_exception(String input) throws Exception{
    	if(null!=input && !input.equals("")){
    		input=input.replaceAll("'", "\"");
			boolean jsonHege=JsonValidator.validate(input);
			if(!jsonHege){
				//throw new CarException("查询二手车时候,由于传进来的queryArgs非json格式出错");
			}
		}
    }
