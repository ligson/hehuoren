...
public class WebFormatter {
	public static void main(String[] args){
		String text = html2text("<div><span>spanspan<a href=''>aaaaaaaaaa</a></span>aaaaaaaa</div><img src=''/>");
		//String text = null;
        ...
        if(c=='<') {
            ...
            if(s_lowerCase.startsWith("<script")) { // this is a script:
                ...
                if(end_script_index==(-1))
                    ...
                    return new Token(Token.TOKEN_SCRIPT, data, start, end_script_index, previousIsPre);
            }
            else { // this is a tag:
...
class Token {
    ...
    private int readUtil(final char[] cs, final int start, final char util, final int maxLength) {
    	//System.out.println(cs.length+"=="+start+"==="+maxLength);
