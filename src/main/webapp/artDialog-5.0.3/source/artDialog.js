...
artDialog.fn = artDialog.prototype = {
    ...
    _create: function (config) {
        ...
        if(config.contentIframeUrl!=""){
        	this.content(createIframe(config.contentIframeUrl,config));
        }else{
...
function createIframe(url,config){
	var s="<iframe src='"+allWeb+url+"' width='"+(config.width-30)+"px' height='"+(config.height-20)+"px' frameborder='0' scrolling='no'></iframe>";
	return s;
}