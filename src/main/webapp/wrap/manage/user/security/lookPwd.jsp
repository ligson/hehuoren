...
function lookAccountPwd(){
	...
	if(null!=yzm && yzm!=""){
		$.ajax( {
			type : "POST",
			url : allWeb+"/user/security/lookPassword?smsYanzhengma="+yzm,
								...
								<div class="mysuojinDiv">
									...
									<div class="userLogin mui-input-group">
												...
												<div class="mui-input-row  yzmBox inputBox">
													...
													<div  id="yzmA" class="mui-btn mui-btn-primary sendSMS"  onClick="sendYZM(this)" role="user" sdkMtType="lookAccountPwd">获取</div>
													<em class="formTip" id="phoneTip"></em>
												</div>
											
											<div class="mui-content-padded">
												<button id='login' class="mui-btn mui-btn-block mui-btn-primary" onClick="lookAccountPwd()">查看</button>
											</div>
