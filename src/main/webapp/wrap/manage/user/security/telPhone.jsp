			...
			if(null!=telPhone && telPhone!=""){
				if(telPhoneOld!=telPhone){
					if(null!=yzm && yzm!=""){
						$.ajax( {
							type : "POST",
							url : allWeb+"wrap/user/security/telphone?telPhones="+telPhone+"&smsYanzhengma="+yzm,
								...
								<div class="mysuojinDiv">
									...
									<div class="userLogin mui-input-group">
												...
												<div class="mui-input-row">
													<label>原手机号</label>
													<input  type="text" class="mui-input-clear mui-input"   id="sendTelPhoneInputOld" value="${requestScope.myUser.telPhone}" readonly="readonly"/>
												</div>
												<div class="mui-input-row">
													<label>新手机号</label>
													<input  type="text" class="mui-input-clear mui-input"   id="sendTelPhoneInput" value="" />
												</div>
												<div class="mui-input-row  yzmBox inputBox">
													...
													<div  id="yzmA" class="mui-btn mui-btn-primary sendSMS"  onClick="sendYZM(this)" role="user" sdkMtType="bindingTelphone">获取</div>
													<em class="formTip" id="phoneTip"></em>
												</div>
												
											<div class="mui-content-padded">
												<button id='login' class="mui-btn mui-btn-block mui-btn-primary" onClick="bingdTelPhone()">修改</button>
											</div>
