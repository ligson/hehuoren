				...
				if(null!=pwd && pwd!=""){
					if(pwd==pwd1){
						if(null!=yzm && yzm!=""){
							$.ajax( {
								type : "POST",
								url : allWeb+"wrap/user/security/password?password="+pwd+"&smsYanzhengma="+yzm,
								...
								<div class="mysuojinDiv">
									...
									<div class="userLogin mui-input-group">
												...
												<div class="mui-input-row  yzmBox inputBox">
													...
													<div  id="yzmA" class="mui-btn mui-btn-primary sendSMS"  onClick="sendYZM(this)" role="user" sdkMtType="modifyPassword">获取</div>
													<em class="formTip" id="phoneTip"></em>
												</div>
												<div class="mui-input-row">
													<label>新密码</label>
													<input  type="text" class="mui-input-clear mui-input"   id="passwordInput" value="" />
												</div>
												<div class="mui-input-row">
													<label>确认密码</label>
													<input  type="text" class="mui-input-clear mui-input"   id="passwordInput1" value="" />
												</div>
											<div class="mui-content-padded">
												<button id='login' class="mui-btn mui-btn-block mui-btn-primary" onClick="modifyPassword()">修改</button>
											</div>
