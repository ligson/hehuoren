				...
				if ( 
					...
					cell
						...
						.click(function () {
							...
							var year=jQuery("select[name=year]", datepicker).val();
							var month=jQuery("select[name=month]", datepicker).val();
							var day=jQuery(this).text();
							month=parseInt(month)+1;
							var myDate=year+"-"+month+"-"+day;
							//alert(year+"-"+month+"-"+day);
							var callFunction=options.callFunction;
							if(null!=callFunction && callFunction!="" && callFunction!="undefined"){
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				jQuery(this).click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						$(this).parent(".riqiBox").prepend(datepicker);;
						//jQuery(".riqiBox").prepend(datepicker);
						// position the datepicker
						var elPos = findPosition($this.get(0));
						var x = (parseInt(opts.x) ? parseInt(opts.x) : 0) + elPos[0];
						var y = (parseInt(opts.y) ? parseInt(opts.y) : 0) + elPos[1];
						jQuery(datepicker).css({ position: 'absolute', left: x, top: 100 });
