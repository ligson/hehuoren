...
.propertyDiv .name{float:left;height:100%;line-height: 30px;background:#eee;color:#666;font-weight: bold;padding-left:5px;padding-right:5px;}
.propertyDiv .value{float:left;line-height: 30px;height:100%;padding-left:5px;}
</style>
