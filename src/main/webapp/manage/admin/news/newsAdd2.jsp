				...
				<div id="bodyR_content">
					<div id="mainContent">
						...
						<div class="centerBox">
							...
							<div class="formBox">
								<form action="<%=request.getContextPath()%>/admin/news/add?newsTypeId=${requestScope.newsType.id}" method="post">
									<input type="hidden" value="redirect:/admin/news/finds" name="redirect"/>
									<div class="item">
										<div class="l"> 标题： </div>
										<div class="r">
											<span>
												<input name="title" type="text" value="" class="textInput"/>
