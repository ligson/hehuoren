			...
			<div id="layout_bodyI_r" style="height:1300px">
				...
				<div id="bodyR_content">
					<div id="mainContent">
						<div class="centerBox">
							<div class="formBox">
								<form action="<%=request.getContextPath()%>/admin/pua/add" method="post">
									...
									<div class="item">
										...
										<div class="r">
											<span>
												<input name="markedNum" type="text" value="" class="textInput" />
											</span>
										</div>
									</div>
									...
									<div class="item">
										...
										<div class="r">
											<span>
												<input name="telPhone" type="text" value="" class="textInput" />
											</span>
										</div>
									</div>
									...
									<div class="item">
										...
										<div class="r">
											<span>
												<input name="addressStr" type="text" value="" class="textInput" />
											</span>
										</div>
									</div>
