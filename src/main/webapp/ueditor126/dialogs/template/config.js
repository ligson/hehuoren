...
var templates = [
    ...
    },
    {
        "pre":"pre4.png",
        'title':lang.test,
        'preHtml':'<div class="myTabDiv" id="myTabDiv_101" width="100%" > <div class="myTab_top"> <ul class="tab_ul"> <li class="cur" contentdiv="tab_content_1013" contentUrl="historyOperation.do?method=findAll_admin&queryArgs=&forwardPage=historyOperationList_ajaxsuper&pageMethod=first&currentPage=1@topHead_1@leftNav_1"><a href="javascript:void(0);">当日历史</a></li><li style="float:right" contentdiv="tab_content_1011" contentUrl="oa_employee.do?method=findAll&queryArgs=&forwardPage=employeeList"><a href="javascript:void(0);">员工中心</a></li><li style="float:right" contentdiv="tab_content_1012" class=""><a href="javascript:void(0);">添加新员工</a></li></ul></div>'+
        '<div class="myTab_bot" style="width: 820px;">'+
		'<div class="myTab_con" id="tab_content_1011" style="display: none;">'+
		'</div>'+
		'<div class="myTab_con" id="tab_content_1012" style="display: none;">'+
		'</div>'+
		'<div class="myTab_con" id="tab_content_1013" style="display: block;">'+
		'</div>'+
	'</div>'+'</div>',
        'html':'<div class="myTabDiv" id="myTabDiv_101" width="100%" > <div class="myTab_top"> <ul class="tab_ul"> <li class="cur" contentdiv="tab_content_1013" contentUrl="historyOperation.do?method=findAll_admin&queryArgs=&forwardPage=historyOperationList_ajaxsuper&pageMethod=first&currentPage=1@topHead_1@leftNav_1"><a href="javascript:void(0);">当日历史</a></li><li style="float:right" contentdiv="tab_content_1011" contentUrl="oa_employee.do?method=findAll&queryArgs=&forwardPage=employeeList"><a href="javascript:void(0);">员工中心</a></li><li style="float:right" contentdiv="tab_content_1012" class=""><a href="javascript:void(0);">添加新员工</a></li></ul></div>'+
        '<div class="myTab_bot" style="width: 820px;">'+
		'<div class="myTab_con" id="tab_content_1011" style="display: none;">'+
		'</div>'+
		'<div class="myTab_con" id="tab_content_1012" style="display: none;">'+
